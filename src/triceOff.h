...
#define TriceInitRingBufferMargins(void)
#define WatchRingBufferMargins(void)
...
#define TriceInit(void)
#define TriceLogDiagnosticData(void)
#define TriceLogSeggerDiagnostics(void)
#define TriceNonBlockingDeferredWrite8(ticeID, enc, encLen) TRICE_UNUSED(ticeID) TRICE_UNUSED(enc) TRICE_UNUSED(encLen)
#define TriceTransfer(void)
#define triceDataLen(p)
#define TriceEnoughSpace(void)
#define TriceOutDepth(void)
#define TriceDepth(void)
#define TriceDepthMax(void)
...
#define triceServeTransmitUartA(void)
#define triceTriggerTransmitUartA(void)
#define TriceOutDepthUartA(void)

#define TriceBlockingWriteUartB(buf, len) TRICE_UNUSED(buf) TRICE_UNUSED(len)
#define triceServeTransmitUartB(void)
#define triceTriggerTransmitUartB(void)
#define TriceOutDepthUartB(void)
